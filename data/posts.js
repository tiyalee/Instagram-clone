...
export const Posts = [
  {
    ...
    profile_pic:Users[0].imageUrl,
    comments: [
        { 
            user: "hhhhhhhhhhhh", 
            comment: "blablablablablbalblab" 
        },
        {
            user:'yeye',
            comment:'omgomgomgomgomg!'
        }
    ],
  },
  {
  ...
  },
  {
    ...
    user: Users[3].firstName,
    likes:666,
    caption: 'Such a great day!= = ',
    profile_pic:Users[3].imageUrl,
    comments: [
        { 
            user: "hhhhhhhhhhhh", 
            comment: "blablablablablbalblab" 
  ...
  },
  {
    ...
    user: Users[4].firstName,
    likes:9564,
    caption: 'Such a great day!= = ',
    profile_pic:Users[4].imageUrl,
    comments: [
        { 
            user: "hhhhhhhhhhhh", 
            comment: "blablablablablbalblab" 
